...
Macon is well connected by interstate but is _not_ equidistant from Atlanta and Savannah: it lies roughly **85 miles** southeast of Atlanta and roughly **160 miles** northwest of Savannah. It is still a natural hub for central Georgia.
...
- **The Spiral Mound**—widely described as the only known spiral (spiral-ramp/staircase) mound in North America, built during the later Lamar Period (ca. 1350–1600). ⚠️ Note: it is **not** at the main Macon Plateau visitor area — it is in the park's separate **Lamar Mounds Unit**, roughly three miles downriver in wetlands. ⚠️ _Unverified:_ public access to the Lamar Unit appears to be restricted (historically by ranger-led tour only), but NPS has no current public page stating the policy. Call the park at (478) 752-8257 before treating it as visitable, and do not build a Pack outing around it.

The park is the ancestral homeland of the **Muscogee (Creek) Nation**, whose citizens today live primarily in Oklahoma; the connection is stated explicitly by the NPS. It's ideal for educational outdoor experiences, trail hiking, and wildlife observation. _(Kayaking, canoeing, and fishing happen on the adjacent Ocmulgee River and along the Ocmulgee Heritage Trail rather than as in-park NPS programs—verify put-in points separately before planning.)_
...
### Downtown Macon & Historic Architecture
...
Located just west of Macon (6600 Moseley Dixon Road, Macon GA 31220), Lake Tobesofkee is a **county-owned** recreation area of nearly **1,800 acres with 35 miles of shoreline**. The dam on Tobesofkee Creek was completed in December 1964 and the lake filled by 1969. _(Note: it is a Macon-Bibb County facility, not a Georgia state park.)_
...
## Culture, Heritage & Family Attractions
...
- **The Allman Brothers Band**—Southern rock icons. The band **formed in Jacksonville, Florida in 1969**, then moved to Macon that April at the urging of manager **Phil Walden**, who was launching Capricorn Records there. _(The band was not "formed from" the label — the label was built around them.)_
...
## Color & Mood Palette Suggestions

Based on Macon's distinctive visual identity and natural landscape, the following color palette is suggested for a family/Cub Scout website:

### Primary Palette

- **Cherry Blossom Accent** – Soft pink (#E8A3C6 or #D4A5A5) – Use sparingly for highlights; evokes spring renewal and the iconic festival season
- **River Green** – Muted sage green (#6B8E7F or #789B7E) – Represents the Ocmulgee River, trails, and outdoor recreation
- **Historic Brick Red** – Warm red-brown (#A0473D or #8B4A3F) – Echoes downtown Macon's historic architecture
- **Slate Blue** – Deep neutral blue (#4A5A6A or #556B7D) – Represents stability, tradition, and heritage

### Supporting Neutrals

- **Warm White/Cream** – Off-white with warmth (#F5F1E8) – Background tone suggesting tradition and friendliness
- **Charcoal Gray** – Deep neutral (#3A3A3A) – For text and structure
...
**Design Note:** Keep cherry blossom pink as an accent (buttons, highlights, borders) rather than a dominant color to avoid overwhelming the palette. Use it sparingly to reference Macon's identity without compromising readability or professional appearance.

---

## Summary for Design Theming

**Macon's strongest design themes for Pack 170's website:**

1. **Cherry Blossom Heritage** – Iconic spring renewal and celebration; instantly recognizable local symbol
2. **Ocmulgee River & Trails** – Outdoor adventure, historical depth, and Scout-aligned activities
3. **Music & Community Pride** – Celebration of local talent and cultural legacy (secondary theme for special events)
4. **Historic Downtown Architecture** – Trustworthiness, permanence, and community roots
5. **Central Georgia Council Connection** – Local Scouting infrastructure and resources
6. **Educational & Family-Focused** – Museum offerings and STEM attractions align with Cub Scout values

**Recommended visual direction:** A clean, modern design with heritage undertones—featuring muted brick/green earth tones, subtle cherry blossom accents, and iconography referencing outdoor trails, river recreation, and scouting traditions. Photography should highlight Macon's parks, trees, and family-friendly outdoor spaces.
