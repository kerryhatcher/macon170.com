...
*Compiled for the Macon 170 Cub Scout pack website project — July 2026*

## 1. History and the 2024/2025 Rebrand

- **May 7, 2024** — The Boy Scouts of America announced it would rebrand its corporate/organizational name to **Scouting America**. The new name was permitted for immediate use starting on the announcement date. ([Scouting Newsroom press release](https://www.scoutingnewsroom.org/press-releases/boy-scouts-of-america-to-become-scouting-america/), [PR Newswire](https://www.prnewswire.com/news-releases/boy-scouts-of-america-to-become-scouting-america-302137787.html))
- **February 8, 2025** — The name change became **official**, timed to coincide with the organization's **115th anniversary** (BSA was founded Feb 8, 1910).
- **Why**: The organization said the change reflects its ongoing commitment to welcoming *every* youth and family in America into Scouting — most notably following the 2019 decision to admit girls into Cub Scouting and what is now Scouts BSA. Quote from President/CEO Roger A. Krone: *"Though our name will be new, our mission remains unchanged: we are committed to teaching young people to be Prepared. For Life."*
- **Key stats cited in the announcement**: 176,000+ girls/young women served, 6,000+ girls earning Eagle Scout, 1M+ total youth participants, 477,000 adult volunteers.
- **What did NOT change**: Program names remain exactly as before — **Cub Scouting, Scouts BSA, Venturing, Sea Scouts, and Exploring** all keep their existing names. There is **no new acronym** — "Scouting America" is not abbreviated (avoid inventing "SA" as shorthand). "Scouting" replaces "Boy Scouts" as the umbrella/corporate term; the Scout Oath and Scout Law are unchanged.
- Program-level visual identity (e.g., the Cub Scout flag/logo, Scouts BSA fleur-de-lis emblem) was **largely retained** — only the corporate wordmark/logo changed to read "Scouting America." (via [freedomandglory.com summary](https://www.freedomandglory.com/blog/the-boy-scouts-of-america-is-rebranding-to-scouting-america-what-you-need-to-know), corroborated by council rebrand toolkits e.g. [Great Falls Council](https://gfcscouting.org/scouting-name-change/), [onscouting.org explainer](https://onscouting.org/2024/05/07/what-our-organizations-name-change-means-and-doesnt-mean-to-scouts-and-leaders/))
...
- **National privacy policy does not cover unit sites.** Scouting America's own [privacy policy](https://www.scouting.org/legal/privacy-policy/) explicitly states it does not apply to individual council or unit websites — **a pack site needs its own privacy policy**, and needs to name a responsible admin/webmaster.
- **COPPA applies.** Scouting America's guidance is not to collect personal information directly from children under 13 without parental consent, consistent with the Children's Online Privacy Protection Act. A pack site should avoid any form that collects a *child's* info directly — route all registration/contact forms through a parent/guardian.
- **Names**: Historical guidance under the Guide to Safe Scouting / Youth Protection framework has been to publish, at most, a **Scout's first name and last initial** — not full names — in any public-facing content (this was the standard even in print-newspaper contexts and carries over to web/social). Never publish a minor's last name, home address, phone number, school name/location, or parents' workplace without explicit parental permission.
- **Photos require consent.** No photo of a Scout under 18 should be published without the **explicit, signed consent of that Scout's parent/guardian** — this is typically covered by a photo-release line on the pack's annual registration/consent forms; the website should not publish beyond what those signed releases cover. ([Coosa District Social Media guide](https://nwgabsa.doubleknot.com/document/coosa-district-media-guide/155245), corroborated by [Scouting Magazine's social-media safety piece](https://scoutingmagazine.org/2021/05/avoid-social-media-safety-pitfalls/))
- **Public, not private, channels.** Any unit web/social presence must be fully public — no private groups, no closed channels — and should have **at least two adult administrators**, at least one of whom is a registered, Youth-Protection-trained leader. This transparency requirement exists specifically so all communication is observable/auditable (ties into the **two-deep leadership** and **no-one-on-one-contact** rules that extend to all digital interaction, not just in-person). ([Scouting Wire Social Media Guidelines](https://scoutingwire.org/social-media-guidelines/))
- **No one-on-one adult-youth contact in any medium** — includes email, text, DMs. If the pack site has a "contact a leader" form or chat-style feature, it should not create a private one-on-one channel between an adult leader and a youth member; route youth-directed communication through parents.
- **Digital safety extends the in-person rules**: All Youth Protection policies (background-checked/trained adults, observability, no closed-door interactions) explicitly extend to the online environment, not just physical meetings. ([Scouting America Digital Safety page](https://www.scouting.org/health-and-safety/safety-moments/digital-safety-and-online-scouting-activities/))

### Design/compliance checklist this implies for macon170.com
- Publish a pack-specific privacy policy (don't rely on/claim the national one).
- Any registration or "contact us" form should be addressed to a parent/guardian, not framed as youth-facing data collection.
- Photo galleries: first-name-and-last-initial captions at most (or no names at all — just group/event captions), and only use photos covered by signed parental consent.
- No embedded youth-only chat/DM feature; keep any contact mechanism public or routed to multiple adults.
- Consider a simple photo opt-out mechanism for families who decline the photo release, consistent with how the pack collects consent on paper/registration forms.

---

## Summary of key sources
- [Scouting Newsroom — rebrand press release](https://www.scoutingnewsroom.org/press-releases/boy-scouts-of-america-to-become-scouting-america/)
- [PR Newswire — official announcement](https://www.prnewswire.com/news-releases/boy-scouts-of-america-to-become-scouting-america-302137787.html)
- [onscouting.org — what the name change does/doesn't mean](https://onscouting.org/2024/05/07/what-our-organizations-name-change-means-and-doesnt-mean-to-scouts-and-leaders/)
- [Scouting Wire — BSA Brand Center](https://scoutingwire.org/bsa-brand-center/brand-identity/)
- [BSA Brand Guidelines PDF](https://filestore.scouting.org/filestore/pdf/310-0231.pdf)
- [BrandColorCode.com — Boy Scouts of America](https://www.brandcolorcode.com/boy-scouts-of-america) / [Cub Scouts](https://www.brandcolorcode.com/cub-scouts)
- [onscouting.org — official BSA colors and logos](https://onscouting.org/2013/06/07/brand-id/)
- [ScoutSmarts — fleur-de-lis history](https://scoutsmarts.com/fleur-de-lis-scouts-history/)
- [Scouting America — Privacy Policy](https://www.scouting.org/legal/privacy-policy/)
- [Scouting Wire — Social Media Guidelines](https://scoutingwire.org/social-media-guidelines/)
- [Scouting America — Digital Safety and Online Scouting Activities](https://www.scouting.org/health-and-safety/safety-moments/digital-safety-and-online-scouting-activities/)
- [Coosa District — Social Media & Scouting guide](https://nwgabsa.doubleknot.com/document/coosa-district-media-guide/155245)
