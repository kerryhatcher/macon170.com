...
| ~~`leadership: []`~~       | **removed** | Resolved 2026-07-27 — the roster now lives in D1 (`leadership_roles`), is edited at `admin.macon170.com/leadership`, and is injected into `/about/` server-side by the worker. No file to edit and no deploy needed.                                                                                                                                  |
