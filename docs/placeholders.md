...
| ~~`links.facebook`~~       | **set**     | Resolved 2026-07-27 — `https://www.facebook.com/Pack170Macon`, from `docs/Official-info.md`. Note the field was referenced **nowhere** before this, so setting it alone rendered nothing; `/resources/` gained a "Day-to-day pack news" card to surface it.                                                                                           |
| ~~`links.scoutbook`~~      | **set**     | Resolved 2026-07-27 — `https://advancements.scouting.org/`, from `docs/Official-info.md`. This is Scouting America's advancement portal, not a Pack 170-specific URL; the card text says so and tells parents to sign in with my.scouting.                                                                                                            |
...
`1`–`6`. Both are now the official Scouting America art from `assets/official/`, resolved through
