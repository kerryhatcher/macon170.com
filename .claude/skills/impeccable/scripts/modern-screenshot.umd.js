(function (y, v) {
  ...
  function W(e) {
    const t = e.length - 1;
    for (let r = t; r >= 4; r--) if (e[r - 4] === 9 && e[r - 3] === N && e[r - 2] === R && e[r - 1] === O && e[r] === X) return r - 3;
    return 0;
  }
  function ae(e, t, r = !1) {
  ...
  function ht(e) {
    ...
    return (
      pe++,
      { time: (r) => e && console.time(`${t} ${r}`), timeEnd: (r) => e && console.timeEnd(`${t} ${r}`), warn: (...r) => e && ct(...r) }
    );
  }
  function wt(e) {
  ...
  function ye(e, t) {
    return C(this, null, function* () {
      ...
      (l.log.time('wait until load'), yield me(e, { timeout: l.timeout, onWarn: l.log.warn }), l.log.timeEnd('wait until load'));
...
`);
  ...
  function St(e, t) {
    var r;
    try {
      if ((r = e == null ? void 0 : e.contentDocument) != null && r.documentElement) return ne(e.contentDocument.documentElement, t);
    } catch (n) {
  ...
  function Ct(e, t) {
    return C(this, null, function* () {
      ...
      if (n) {
        let i = !0;
        if ((yield L(r, { onError: () => (i = !1), onWarn: t.log.warn }), !i)) return e.poster ? _(e.poster, e.ownerDocument) : r;
  ...
  function Rt(e, t, r, n) {
    ...
    (l.delete('transition-property'),
      ...
      ((d = l.get('background-clip')) == null ? void 0 : d[0]) === 'text' && t.classList.add('______background-clip--text'),
      le &&
  ...
  function Pt(e, t, r, n, i) {
    ...
    function u(l) {
      ...
      (g.delete('content'),
        ...
        ((w = g.get('background-clip')) == null ? void 0 : w[0]) === 'text' && t.classList.add('______background-clip--text'));
      const p = [`content: '${m}';`];
      if (
        (g.forEach(([S, T], A) => {
  ...
  function ve(e, t, r, n, i) {
    return C(this, null, function* () {
      ...
      Te.has(t.nodeName) || Te.has(r.nodeName) ? (n.currentParentNodeStyle = void 0) : (n.currentParentNodeStyle = n.currentNodeStyle);
  ...
  function Ae(e, t, r, n) {
    return C(this, null, function* () {
      var a;
      let i = e.firstChild;
      I(e) && e.shadowRoot && ((i = (a = e.shadowRoot) == null ? void 0 : a.firstChild), r.shadowRoots.push(e.shadowRoot));
    ...
    return C(this, null, function* () {
      ...
      if (i && a && I(e) && (V(e) || H(e))) {
        ...
        if (t.isEnable('copyScrollbar')) {
          const w = [(u = h.get('overflow-x')) == null ? void 0 : u[0], (l = h.get('overflow-y')) == null ? void 0 : l[0]];
          g =
            w.includes('scroll') ||
            ((w.includes('auto') || w.includes('overlay')) && (e.scrollHeight > e.clientHeight || e.scrollWidth > e.clientWidth));
        }
  ...
  function z(e, t) {
    ...
    if (!E) {
      ...
      const S = b && w.size,
        T = D({ url: s, timeout: o, responseType: S ? 'arrayBuffer' : i, headers: n === 'image' ? { accept: c } : void 0 }, d);
      ((E = { type: n, resolve: void 0, reject: void 0, response: null }),
        (E.response = C(this, null, function* () {
          ...
          if ((u.delete(r), n === 'image' && f))
            return (e.log.warn('Failed to fetch image base64, trying to use placeholder image', s), typeof f == 'string' ? f : f(a));
          throw A;
        })),
        u.set(r, E));
    }
  ...
  const xt = ['background-image', 'border-image-source', '-webkit-border-image', '-webkit-mask-image', 'list-style-image'];
  function Mt(e, t) {
    return xt
      .map((r) => {
  ...
  function jt(e, t) {
    ...
    if (s) {
      const c = `#${s}`,
        u = t.shadowRoots.reduce((l, d) => (l != null ? l : d.querySelector(`svg ${c}`)), r == null ? void 0 : r.querySelector(`svg ${c}`));
...
`;
      ...
      const w = Yt(g, r);
      return (o && w.insertBefore(o, w.children[0]), s && w.insertBefore(s, w.children[0]), d && Ne(r), yield h == null ? void 0 : h(w), w);
    });
  }
  function Yt(e, t) {
  ...
  function Kt(e, t) {
    return C(this, null, function* () {
      const r = yield k(e, t),
        ...
        u = _(c, n);
      return ((u.width = Math.floor(i * s)), (u.height = Math.floor(a * s)), (u.style.width = `${i}px`), (u.style.height = `${a}px`), u);
    });
  }
  function Qt(e, t) {
    return C(this, null, function* () {
