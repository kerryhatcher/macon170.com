...
This project is the website for a Cub Scouting pack serving families with
elementary-age children. We hold contributors and maintainers to that context:
communication here should be something you'd be comfortable with a parent
volunteer or a Scout reading.
...
requests, discussions) related to this repository, and also applies when an
individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainer at **kerry@kerryhatcher.com**. All complaints will
